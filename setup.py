...
setup(name="dependency-injector",
      ...
      author="Rúben Garcia",
      author_email="rubenribeirogarcia@gmail.com",
      maintainer="Rúben Garcia",
      maintainer_email="rubenribeirogarcia@gmail.com",
      url="https://github.com/RubenRibGarcia/python-dependency-injector",
      download_url="https://pypi.python.org/pypi/python-dependency-injector",
      packages=[
          "dependency_injector",
